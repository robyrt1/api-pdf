...
const laudosTemplate = (data) => {
  ...
  */
  ...
  <body>
    <div>
      <!--header inicio-->
      <div style="display:-webkit-flex; width: 100%; margin-bottom:10px;">
        <div style="border: solid 1px #93b8a6; display:-webkit-flex; -webkit-justify-content: center; width:30%;">
          <img width="100"
        ...
        <div
          style="border: solid 1px #93b8a6; width: 100% ; display:-webkit-inline-flex; -webkit-align-items: center; -webkit-justify-content:center;">
          <div style="width:75%">
            <h5 style="margin: 10px 0px 0px 0px; text-align: center;">
              <strong>
                SAMEL SERVICOS DE ASSISTENCIA MEDICO HOSPITALAR LTDA
              </strong>
            </h5>
            <p style="margin: 0px; text-align: center; display: flex; justify-content: center;">
              <small>
                Rua Joaquim Nabuco, 1755 - Manaus - AM - CEP 69020030 - Fone: 21292200
              </small>
            </p>
            <p style="margin: 0px 0px 5px 0px;text-align: center; display: flex; justify-content: center; ">
              <small>
    ...
    <div
      style="display:-webkit-inline-flex; width: 98%; margin-bottom: 10px; border: solid 1px #93b8a6; padding-left: 10px;">
      <div style=width:50%; border: solid 1px #93b8a6; padding-left: 10px;>
        <p style="margin:5px 0px 0px 0px;"><strong>Paciente:</strong> @nomeCliente</p>
        <p style="margin:0px 0px 5px 0px;"><strong>Data Nasc:</strong> @dataNascimento</p>
      </div>
      <div style="width: 50%;padding-left: 10px;border-left: solid 1px #93b8a6;">
        <p style="margin:5px 0px 0px 0px;"><strong>Convênio:</strong> @dsConvenio</p>
        <p style="margin:0px 0px 5px 0px;"><strong>Setor:</strong> @dsSetor</p>
      </div>
    </div>
  
    <div style="display:-webkit-inline-flex; width: 100%; margin-bottom: 10px; height: 100px;">
      <div style="width:60%; border: solid 1px #93b8a6;">
        <p style="margin:5px 0px 5px 10px;">
          <strong> @tipoProfissional:</strong> @profissional
        </p>
        <p style="margin:5px 0px 5px 10px;"><strong>Data de Entrada: </strong>@dataEntrada</p>
      </div>
      <div style="width:40%; border: solid 1px #93b8a6; padding-left: 10px;">
        <p style="margin: 5px 0px 0px 0px; text-align: left;"><strong>Assinatura:</strong></p>
        <p style="margin:5px 0px 5px 0px; text-align: left; ">@dsAssinatura</p>
      </div>
    </div>
