...
class LaudosPdfService {
  async getGeneratePDF(data) {
    ...
    const options = {
      ...
      type: "pdf",
      quality: "75",
      renderDelay: 1000, // Override the initial pagination number
      border: {
          ...
          last: `
            <div style="display:-webkit-inline-flex; width: 98%; margin-bottom: 10px; border: solid 1px #93b8a6; padding-left: 10px;">
                <div style=width:50%; border: solid 1px #93b8a6;  padding-left: 10px;>
                    <p style="margin:5px 0px 0px 0px;"><strong>Paciente:</strong>Robert Pinto Mendes</p>
                    <p style="margin:0px 0px 5px 0px;"><strong>Data Nasc:</strong>12/02/2003</p>
            ...
            <div style="display:-webkit-inline-flex; width: 100%; margin-bottom: 10px; height: 100px;">
                ...
                <div style="max-width:50%; border: solid 1px #93b8a6; padding-left: 10px;">
