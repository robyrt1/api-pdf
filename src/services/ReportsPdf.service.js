  ...
  async getGeneratePDF(data) {
    try {
      ...
      const htmlWithNewTags = `
          ...
          <body>
              <div class="template" style="margin:10px; font-size:5pt">
                  ${template}
              <div>
          </body>
          </html>`;
      ...
      const options = {
        ...
        footer: {
          ...
          contents: {
            last: `
              <div style="display:-webkit-inline-flex; width: 98%; margin-bottom: 10px; border: solid 1px #93b8a6; padding-left: 10px;">
                  <div style=width:50%; border: solid 1px #93b8a6;  padding-left: 10px;>
                      <p style="margin:5px 0px 0px 0px;"><strong>Paciente:</strong> ${data.atendimento[0].nomeCliente}</p>
                      <p style="margin:0px 0px 5px 0px;"><strong>Data Nasc:</strong> ${data.atendimento[0].dataNascimento}</p>
              
                  </div>
                  <div style="width: 50%;padding-left: 10px;border-left: solid 1px #93b8a6;">
                      <p style="margin:5px 0px 0px 0px;"><strong>Convênio:</strong> ${data.atendimento[0].dsConvenio}</p>
                      <p style="margin:0px 0px 5px 0px;"><strong>Setor:</strong> ${data.atendimento[0].dsSetor}</p>
                  </div>
              </div>
              
              <div style="display:-webkit-inline-flex; width: 100%; margin-bottom: 10px; height: 100px;">
                  <div style="width:72%; border: solid 1px #93b8a6;">
                      <p style="margin:5px 0px 5px 10px; text-align: center; ">
                          <strong> ${data.tipoProfissional}:</strong> ${data.profissional}
                      </p>
                      <p style="margin:5px 0px 5px 10px;text-align: center;"><strong>Data de Entrada:</strong>
                          ${data.atendimento[0].dataEntrada}</p>
                  </div>
                  <div style="max-width:30%; border: solid 1px #93b8a6; padding-left: 10px;">
                      <p style="margin: 5px 0px 0px 0px; text-align: left;"><strong>Assinatura:</strong></p>
                      <p style="margin:5px 0px 5px 0px; text-align: left; width:10%; ">
                          ${data.atendimento[0].dsAssinatura}</p>
                  </div>
              </div>
            `,
          },
